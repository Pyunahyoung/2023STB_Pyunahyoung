...
barplot(table(z),xlab="연봉평균",ylab="도수",main="연봉그래프의 분포")
...
print(meanofz3)
barplot(table(z3),xlab="평균",ylab="도수", main="표본크기3의 도수분포표")
...
library(sampling)
sam2=strata(data=iris,stratanames=c("Species"),size=c(3,3,3),method='srswor') #iris데이터 사용하여 표본추출, Species픙을 기준으로
